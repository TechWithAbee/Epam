...
# If the passed directory is not a directory or does not exist, raise the ValueError. 
...
# Outside the context, the directory is restored
print("Current directory outside context:", os.getcwd())
